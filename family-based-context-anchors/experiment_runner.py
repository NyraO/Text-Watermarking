...
import watermark_new as wm
from watermark_new import find_main_sentence, sent_tokenize
...
def run_experiment(file_name):
    ...
    # Save the watermarked text 
    base, ext = os.path.splitext(file_name)
    out_path = f"{base}.watermarked{ext}"
